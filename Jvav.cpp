/*
    Jvav Programmer Ver.02w05d Snapshot
    By 30266
...
int main()
{
    ...
    cout << "--------------------------------------------\n";
    cout << "| Jvav Programm         Ver.02w05dSnapshot |\n";
...
main:
    ...
    if (command == "help") {
        ...
        cout << ">>U-Detecting updates online...\n";
        Sleep(5000);
        cout << ">>U-Error! The update failed! Because the version list cannot be obtained on the authentication server!\n";
        goto main;
    }
